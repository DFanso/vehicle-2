      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <h2 className="text-xl font-bold mb-4">VehicleStore</h2>
            <p className="text-neutral-400 mb-4">
              The best place to find and purchase your dream vehicle online.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/vehicles" className="text-neutral-400 hover:text-white">Vehicles</a></li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><a href="/vehicles?type=SEDAN" className="text-neutral-400 hover:text-white">Sedans</a></li>
              <li><a href="/vehicles?type=SUV" className="text-neutral-400 hover:text-white">SUVs</a></li>
              <li><a href="/vehicles?type=TRUCK" className="text-neutral-400 hover:text-white">Trucks</a></li>
              <li><a href="/vehicles?type=HATCHBACK" className="text-neutral-400 hover:text-white">Hatchbacks</a></li>
              <li><a href="/vehicles?fuelType=ELECTRIC" className="text-neutral-400 hover:text-white">Electric Vehicles</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <address className="not-italic text-neutral-400">
              ...
              <p>Email: info@vehiclestore.com</p>
            </address>
          </div>
        </div>
        ...
        <div className="border-t border-neutral-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-neutral-400 text-sm">&copy; {currentYear} VehicleStore. All rights reserved.</p>
          <div className="mt-4 md:mt-0">
            <ul className="flex space-x-4 text-sm">
              ...
              <li><a href="/sitemap" className="text-neutral-400 hover:text-white">Sitemap</a></li>
            </ul>
          </div>
        </div>
      </div>
